...
class QuizBLoC extends StatefulWidget {
  ...
  const QuizBLoC({super.key, required this.theme});

  @override
  QuizBLoCState createState() => QuizBLoCState();
}

class QuizBLoCState extends State<QuizBLoC> {
                    ...
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        ...
                        side: userAnswer == null
                            ? const BorderSide(
                                color: Colors
                                    .purple) // Bordure orange si pas encore répondu
                            : BorderSide.none,
                      ),
